...
This guide will show you how to set up Hazelcast with https://kubernetes.io/docs/tasks/run-application/horizontal-pod-autoscale/[Kubernetes Horizontal Pod Autoscaler (HPA)].

include::{templates-url}/link-to-repo.adoc[]

== What You’ll Learn

In this guide you will deploy Hazelcast to Kubernetes cluster and set up HPA using https://kubernetes.io/docs/tasks/debug-application-cluster/resource-usage-monitoring/#resource-metrics-pipeline[Resource Metrics] and https://kubernetes.io/docs/tasks/debug-application-cluster/resource-usage-monitoring/#full-metrics-pipeline[Custom Metrics].
